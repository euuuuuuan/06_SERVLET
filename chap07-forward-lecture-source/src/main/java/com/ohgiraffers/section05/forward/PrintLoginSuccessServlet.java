package com.ohgiraffers.section05.forward;
...
public class PrintLoginSuccessServlet extends HttpServlet {
    ...
    * */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * 해당 서블릿에서 사용하기 위해 request에서 다시 꺼낸다.
         * */
        ...
        * 으로 데이터 공유를 할 수 없다.
        * 하지만 forward 방식은 request와 response를 포함하여 위임하므로 request 정보를
        ...
        * 을 하게되면 동일한 요청을 반복하여 데이터 베이스에 insert하는 등의 행위가 중복될 가능성이 있다.
