...
<h4>a태그의 href 속성에 파라미터를 QueryString 형태로 작성하여 get 방식 요청</h4>
<a href="http://localhost:8080/querystring?name=%EB%B0%95%ED%83%9C%EA%B7%BC&age=20&birthday=2004-07-01&gender=M&national=ko&hobbies=movie&hobbies=music">
